...
import {AtariSwapRouterContract, AtariWorldCoin, wNativeCoinAddress, AtariSwapPair} from "../../contract/etherContracts"
...
function Liquidity2(props){
    ...
    useEffect(()=>{
        //console.log(balance1,amount1.toString(),reserve0,reserve1);
        ...
        <div className = "x-defi-buyCard2">
            <div>
                ...
                <Grid container className = "Lp-balance-field">
                    ...
                    <Grid xs={12} sm={12} md={4}>
                        ETH {parseFloat(Number(lpFTMBalance).toFixed(4))}
                    </Grid>
                    <Grid xs={12} sm={12} md={4}>
