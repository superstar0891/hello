...
import {AtariSwapRouterContract, AtariSwapFactoryContract, AtariWorldCoin, wNativeCoinAddress, AtariSwapPair} from "../../contract"
...
function Liquidity2(props){
    ...
    const [token1, setToken1] = useState("FTM");
    const [token2, setToken2] = useState("AtariCoin");
    ...
    // setTokenaddress
    useEffect(()=>{
        var tokenAddress1 = token1==="AtariCoin"? AtariWorldCoin.address:wNativeCoinAddress;
        setTokenAddress1(tokenAddress1);

        var tokenAddress2 = token2==="AtariCoin"? AtariWorldCoin.address:wNativeCoinAddress;
        ...
        async function getBalances(){
            if(connected){
                ...
                setBalance1(token1==="AtariCoin"? balance1:balance2) ;
                setBalance2(token2==="AtariCoin"? balance1:balance2) ;
        ...
        <div className = "x-defi-buyCard2">
            <div>
                ...
                <Grid container className = "Lp-balance-field">
                    ...
                    <Grid xs={12} sm={12} md={4}>
                        FTM {parseFloat(Number(lpFTMBalance).toFixed(4))}
                    </Grid>
                    <Grid xs={12} sm={12} md={4}>
