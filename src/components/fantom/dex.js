...
import { AtariWorldCoin, AtariSwapPair} from "../../contract"
...
function Dex(){
    ...
    const [token1, setToken1] = useState("Fantom (FTM)");
        ...
        return (
            <div style={{display:'flex', textAlign:'right', justifyContent:'center'}}>
                <div style={{alignSelf:'center'}}>
                    <p style={{color:'white', fontSize:12, textAlign:'right'}}>Fantom (FTM)</p>
                ...
                <Grid item xs = {12} sm = {12} md = {12}>
                    <Grid container>
                        <Grid item xs = {12} sm = {12} md = {4} lg={4}>
                            {token1==="Fantom (FTM)"?<FTMCard />:<ATARICard />}
                        </Grid>
                    ...
                    <div style={{textAlign:"center", marginBottom:80}}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs = {12} sm = {12} md = {4} lg={4} style={{alignSelf:'center'}}>
                                <span style={{color:'white', fontSize:15, textAlign:'right'}}>FTM {parseFloat(Number(reserve1).toFixed(5))}</span>
                            </Grid>
                            <Grid item xs = {12} sm = {12} md = {4} lg={4}>
