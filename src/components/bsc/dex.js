...
import image2 from '../../assets/img/BNB-bg.png';
import image3 from '../../assets/img/3.png';
import image7 from '../../assets/img/7.png';
import {AtariWorldCoin,AtariSwapPair} from "../../contract/bscContracts"
...
function Dex(){
    ...
    const [token1, setToken1] = useState("BNB (BNB)");
        ...
        return (
            <div style={{display:'flex', textAlign:'right', justifyContent:'center'}}>
                <div style={{alignSelf:'center'}}>
                    <p style={{color:'white', fontSize:12, textAlign:'right'}}>BNB (BNB)</p>
                ...
                <Grid item xs = {12} sm = {12} md = {12}>
                    <Grid container>
                        <Grid item xs = {12} sm = {12} md = {4} lg={4}>
                            {token1==="BNB (BNB)"?<FTMCard />:<ATARICard />}
                        </Grid>
                    ...
                    <div style={{textAlign:"center", marginBottom:80}}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs = {12} sm = {12} md = {4} lg={4} style={{alignSelf:'center'}}>
                                <span style={{color:'white', fontSize:15, textAlign:'right'}}>BNB {parseFloat(Number(reserve1).toFixed(5))}</span>
                            </Grid>
                            <Grid item xs = {12} sm = {12} md = {4} lg={4}>
